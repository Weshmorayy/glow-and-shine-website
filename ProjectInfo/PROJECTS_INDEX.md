# 📑 Index des Projets — Agence Weshmorayy

Ce document recense tous les projets de l'agence, leur statut et leurs dépôts associés.

| Client / Projet | Slug | Repo GitHub | Type | Statut | Dossier Documents |
|---|---|---|---|---|---|
...
## 🛠️ Outils & Documents Clés

- **Script d'initialisation client** : `new-client` (exécutable dans Termux)
